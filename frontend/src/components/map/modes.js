...
export const MODES = [
  { key: 'partisan_lean',  label: 'Partisan lean (PVI)',  tiers: ['state', 'county', 'district'], ramp: 'diverging',  fmt: margin },
  { key: 'forecast',       label: 'Forecast (win prob.)', tiers: ['state', 'district'],           ramp: 'diverging',  fmt: pct },
  { key: 'average_margin', label: 'Polling average margin', tiers: ['state', 'district'],         ramp: 'diverging',  fmt: margin },
  { key: 'volatility',     label: 'Volatility index',     tiers: ['state', 'district'],           ramp: 'sequential', fmt: raw },
  { key: 'turnout',        label: 'Turnout / early vote', tiers: ['state', 'county', 'district'], ramp: 'sequential', fmt: pct },
...
export const DEMO_MODES = [
  { key: 'demo:education:bachelors_plus',        label: 'Education — bachelor’s+',    fmt: pct },
  ...
  { key: 'demo:housing_urbanicity:urban_share',  label: 'Urbanicity — urban share',        fmt: pct },
  { key: 'demo:race_ethnicity:nonwhite_share',   label: 'Race/ethnicity — nonwhite share', fmt: pct },
  { key: 'demo:social_nativity:foreign_born',    label: 'Foreign-born share',              fmt: pct },
];
